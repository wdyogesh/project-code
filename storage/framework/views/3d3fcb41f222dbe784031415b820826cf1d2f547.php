...
<div class="login-form">
  ...
  <div class="row">
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <h1>Other Party Setup Password</h1>
     <?php if($errors->any()): ?>
   ...
   <?php endif; ?> 
   <form action="<?php echo e(url('other-party-set-password')); ?>" class="bootstrap-modal-form" method="post">
    ...
    <input type='hidden' name='other_party_id' value="<?php echo e($other_party_id); ?>" class="form-control"/>
