...
Business Manager-Manage Mail Group
...
<?php $__env->startSection('content'); ?>
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="<?php echo e(url('manager/add-group')); ?>" class="btn btn-info pull-right">
           Add Group
      </a>
    </section>
      ...
      <table id="example1" class="table table-bordered table-striped">
          ...
          <?php if(isset($mail_group)): ?>
            ...
            <tr>
              ...
              <?php if($group['mail_group_common_user_id'] == Auth::user()->id): ?>
              <td>
               <a href="<?php echo e(url('manager/edit-group/'.Hashids::encode($group['group_user_id']))); ?>" class="btn btn-info" title="Edit">
...
<script>
var url = "<?php echo e(url('manager/delete-group')); ?>";
