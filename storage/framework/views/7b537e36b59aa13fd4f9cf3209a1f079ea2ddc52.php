      ...
      <div class="row">
        ...
        <div class="col-md-9">
                ...
                <div class="box-footer">
                  ...
                  <div class="col-md-2"  >
                  <a href="<?php echo e(url('manager/create-notes/'.Hashids::encode($client_record['id']))); ?>" class="btn btn btn-success btn-flat pull-right">Add Note</a>
                  </div>    
                </div><br>
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
             ...
             <?php if($notes['added_by_id'] == Auth::user()->id): ?>
               <a href="<?php echo e(url('manager/edit-client-notes/'.Hashids::encode($notes['notes_id']).'/'.Hashids::encode($notes['client_id']))); ?>" class="btn btn-info" title="Edit">
...
<script>
  var url = "<?php echo e(url('manager/delete-client-notes')); ?>";
...
$("#message").on('keyup blur keypress', function() {
  ...
  if(mesg.length == 0){
    $.ajax({
            type: "POST",
            url: "<?php echo e(url('manager/searchnotes')); ?>",
