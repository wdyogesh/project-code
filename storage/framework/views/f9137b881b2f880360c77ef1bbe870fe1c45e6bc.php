		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					...
					<a href="<?php echo e(url('admin/create-ticket')); ?>" class="btn btn-info pull-right">
					 New
				 </a>
				...
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo e($my_ticket->business_name); ?></td>
							...
							<td>
							<a href="<?php echo e(url('admin/open-thread/'.Hashids::encode($my_ticket->id))); ?>" class="btn btn-info">Open Thread</a>
                            <?php if($my_ticket->closed == 0): ?>
							<a href="<?php echo e(url('admin/closed-tickets/'.$my_ticket->id)); ?>" class=" btn btn-danger">Close Ticket</a>
							<?php else: ?>
