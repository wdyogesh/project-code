		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<?php endif; ?>
					<form action="<?php echo e(url('manager/edit-other-party-category')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
						...
						<div class="modal-body">
							...
							<div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Category Name" name="category_name" value="<?php echo e($record['category_name']); ?>" maxlength="25">
										<span class="text-danger"><?php echo e($errors->first('	category_name')); ?></span>
									</div>
								</div>
								
								</div>
								<input type="hidden" name="category_id" value="<?php echo e($record['id']); ?>">
								<input type="hidden" name="category_hidden_name" value="<?php echo e($record['category_name']); ?>">
                            <div class="form-group" align="center">
								<a href="<?php echo e(url('manager/manage-other-party-category')); ?>" class="btn btn-info">
									Go back
								</a>
