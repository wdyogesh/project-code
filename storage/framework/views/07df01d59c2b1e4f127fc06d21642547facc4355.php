...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<?php echo $__env->make('frontend.client.layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<!-- Left side column. contains the logo and sidebar -->
		<?php echo $__env->make('frontend.client.layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			         ...
			         <form action="<?php echo e(url('client/edit-profile-picture')); ?>" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
		...
		<!-- /.content-wrapper -->
		<?php echo $__env->make('frontend.client.layouts.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
