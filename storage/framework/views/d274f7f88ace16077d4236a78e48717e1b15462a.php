		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<?php endif; ?>
					<form action="<?php echo e(url('manager/store-employee')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control" name="role_name">
											...
											<option value="<?php echo e($business_managers_employee_role->id); ?>"><?php echo e($business_managers_employee_role->employee_role_name); ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Employee Name" name="employee_name" value="<?php echo e(old('employee_name')); ?>" maxlength="25">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Surname" name="surname" value="<?php echo e(old('surname')); ?>" maxlength="20">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input type="text" class="form-control" name="dateof_birth" id="datepicker" placeholder="DD/MM/YYYY ">
										<span class="text-danger"><?php echo e($errors->first('dateof_birth')); ?></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Employee Email" name="employee_email" value="<?php echo e(old('employee_email')); ?>" maxlength="30">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Pin Code" name="pincode" value="<?php echo e(old('pincode')); ?>" maxlength="6">
