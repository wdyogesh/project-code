...
<div class="login-form">
  ...
  <div class="row">
   ...
   <?php endif; ?> 
   <form action="<?php echo e(url('set-password')); ?>" class="bootstrap-modal-form" method="post">
    ...
    <input type='hidden' name='employee_or_staff_id' value="<?php echo e($employee_or_staff_id); ?>" class="form-control"/>
