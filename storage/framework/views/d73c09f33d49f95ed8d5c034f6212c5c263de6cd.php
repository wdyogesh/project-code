...
<?php $__env->startSection('content'); ?>
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo e(url('client/mail-box')); ?>" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="<?php echo e(url('client/compose-message/ot')); ?>" class="btn <?php echo e(Request::is('client/compose-message/ot')? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope"></span> Other Party</a>
               ...
               <div class="col-md-2">
                <a href="<?php echo e(url('client/compose-message')); ?>" class="btn btn-default btn-sm" title="Refresh"><i class="fa fa-refresh"></i></a>
              </div>
            </div>
            <!-- /.box-header -->
          <form action="<?php echo e(url('client/send-mail')); ?>" class="-bootstrap-modal-form" method="post" enctype="multipart/form-data">
...
<?php $__env->startSection('example-script'); ?>
    ...
    <script>
        $('#tag_list').select2({
            ...
            ajax: {
                url: "<?php echo e(url('client/emial-data')); ?>",
                dataType: 'json',
