  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-xs-8" style="float: right;">
            ...
            <div class="col-xs-1">
                <a href="<?php echo e(url('employee/appointments/'.Hashids::encode(1))); ?>" class="btn <?php echo e(Request::is('employee/appointments') || Request::is('employee/appointments/'.Hashids::encode(1))? 'btn-warning' : 'btn-info'); ?>">
              1 Day
               </a>
            </div>
            <div class="col-xs-1">
              <a href="<?php echo e(url('employee/appointments/'.Hashids::encode(3))); ?>" class="btn <?php echo e(Request::is('employee/appointments/'.Hashids::encode(3))? 'btn-warning' : 'btn-info'); ?>">
                  3 Days
              </a>
            </div>

            <div class="col-xs-1">
               <a href="<?php echo e(url('employee/appointments/'.Hashids::encode(6))); ?>" class="btn <?php echo e(Request::is('employee/appointments/'.Hashids::encode(6))? 'btn-warning' : 'btn-info'); ?>">
                  6 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="<?php echo e(url('employee/appointments/'.Hashids::encode(7))); ?>" class="btn <?php echo e(Request::is('employee/appointments/'.Hashids::encode(7))? 'btn-warning' : 'btn-info'); ?>">
                  7 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="<?php echo e(url('employee/appointments/'.Hashids::encode(5))); ?>" class="btn <?php echo e(Request::is('employee/appointments/'.Hashids::encode(5))? 'btn-warning' : 'btn-info'); ?>">
                  Work Week
              </a>
            </div>
      </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" style="background-color: #483e3d ">
          <div>    <!-- //start form -->
            <form action="<?php echo e(url('employee/store-appointment')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
            ...
            <div class="bootstrap-timepicker">
              <div class="form-group">
               ...
               <input type="hidden" name="manager_id" value="<?php echo e($manager_id['manager_id']); ?>">
    ...
    <div id="record-edit" style="display: none">  
      ...
      <div class="modal-body">
        <div id="view-show" class="box-body">
          <form action="<?php echo e(url('employee/update-appointment')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
            <?php echo e(csrf_field()); ?>
...
<script>
  var deleteurl = "<?php echo e(url('employee/delete-appointment')); ?>";
  var editurl = "<?php echo e(url('employee/edit-client-appointment')); ?>";
  var redirect_url= "<?php echo e(url('employee/client-details')); ?>";
  var cancel_appointment_url = "<?php echo e(url('employee/cancel-appointment')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.employee.layouts.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>pty();
                $("#state").append('<option>Select</option>');
                $("#city").append('<option>Select</option>');
                $.each(res,function(key,value){
                    $("#state").append('<option value="'+value+'">'+value+'</option>');
