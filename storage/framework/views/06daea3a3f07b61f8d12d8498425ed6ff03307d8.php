...
<div class="login-form">
  ...
  <div class="row">
   ...
   <?php endif; ?> 
    <form class="-bootstrap-modal-form" action="<?php echo e(url('other-party-set-security-question')); ?>" method="post" files='true'>
<?php echo e(csrf_field()); ?>
    ...
    <div class="form-group" style='display:none;' id='security_question_answer'>
     ...
     <input type='hidden' name='other_party_id' value="<?php echo e($other_party_user_id); ?>" class="form-control"/>
