				...
				<table id="example1" class="table table-bordered table-striped">
					...
					<?php if(isset($all_records)): ?>
						...
						<tr>
							...
							<?php endif; ?>
							<td>
							<?php if($category['role_name'] == "Business Manager"): ?>
							--
							<?php else: ?>
							 <a href="<?php echo e(url('employee/edit-notes-category/'.Hashids::encode($category['category_id']))); ?>" class="btn btn-info" title="Edit">
