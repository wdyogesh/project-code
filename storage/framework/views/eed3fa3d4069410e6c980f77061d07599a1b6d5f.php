 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo e(url('employee/compose-message')); ?>" class="btn btn-primary btn-block margin-bottom">Compose</a>
      ...
      <form method="post" action="<?php echo e(url('employee/trash')); ?>">
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($inbox_message->master_table_email_id); ?>">
                    ...
                    <td>
                    <a href="<?php echo e(url('employee/important',$inbox_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($inbox_message->user_id != ""): ?> text-yellow <?php endif; ?>"></i></a></td>

                    <td class="mailbox-name"><a href="<?php echo e(url('employee/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'.Hashids::encode(1) )); ?>" title="Subject"><?php echo e($inbox_message->subject); ?></a></td>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($inbox_message->master_table_email_id); ?>">
                    ...
                    <td>
                     <a href="<?php echo e(url('employee/important',$inbox_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($inbox_message->email_table_id != ""): ?> text-yellow <?php endif; ?>"></i></a></td>
                    </td>
                    <td class="mailbox-name"><a href="<?php echo e(url('employee/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'. Hashids::encode(2) )); ?>" title="Subject"><?php echo e($inbox_message->subject); ?></a></td>
