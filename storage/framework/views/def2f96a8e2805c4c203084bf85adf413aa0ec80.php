		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="<?php echo e(url('client/create-notes')); ?>" class="btn btn-info pull-right">
					 Create
				 </a>
					...
					<?php if(isset($all_client_notes)): ?>
						...
						<tr>
                           ...
                           <?php endif; ?>
							...
							<?php endif; ?> -->
							<td>
							 <a href="<?php echo e(url('client/note-details/'.Hashids::encode($notes['notes_id']))); ?>" class="btn btn-warning btn-detail open_modal" title="Details">
								<span class="glyphicon glyphicon-folder-open"></span>
							 </a>
							 <?php if($notes['role_name'] == 'Business Manager' || $notes['role_name'] == 'Staff'): ?>
							 <?php else: ?>
							 <a href="<?php echo e(url('client/edit-notes/'.Hashids::encode($notes['notes_id']))); ?>" class="btn btn-info" title="Edit">
...
<script>
	var url = "<?php echo e(url('client/delete-notes')); ?>";
