...
<head>
  ...
  <title>Intell-Comm Manager Remember Security Question</title>
...
<body>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <!--  <li><img src="<?php echo e(asset('frontpages/html/images/user_icon.png')); ?>"><a href="<?php echo e(url('manager-registration')); ?>">New Business User</a></li>
               ...
               <li><img src="<?php echo e(asset('frontpages/html/images/user_icon.png')); ?>"><a href="http://intell-comm.com/manager-registration">New Users</a></li>
               <li>
               <img src="<?php echo e(asset('frontpages/html/images/registered_user.png')); ?>"><a href="http://intell-comm.com/login-category">Registered Users</a>
               </li>
             </ul>
           </div>
         </div>
  ...
  <div class="registration_section main">
   ...
   <?php if(Session::has('fail')): ?>
    <div  align="center" id="successMessage" class="alert alert-danger" style="color:red"><?php echo e(Session::get('fail')); ?>
    ...
    <?php endif; ?> 
       ...
       <h1>Your Registered Security Question</h1>

    <form class="bootstrap-modal-form" action="<?php echo e(url('manager/check-security-question-answer')); ?>" method="post" files='true'>
    ...
    <div class="form-group" style='display:none;' id='security_question_answer'>
     ...
     <input type='hidden' name='manager_id' value="<?php echo e($manager_id); ?>" class="form-control"/>
    <div class="learn_more_btn">
      <button type="submit" class="btn btn-success">Submit</button>
    </div>
    <div class="learn_more_btn">
      <a href="<?php echo e(route('manager-login',[$subdomain,Hashids::encode($manager_id)])); ?>">Go back to login page</a>
    </div>
   </div>
    </form>
      </div>
