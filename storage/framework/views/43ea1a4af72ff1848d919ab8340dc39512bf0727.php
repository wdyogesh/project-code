...
Business Managers-Face-To-Face-Employees
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <a href="<?php echo e(route('employee-send-invitation')); ?>" class="btn btn-info pull-right">
           Send New Invitation
            </a>
          ...
          <?php if(isset($main_other_party_invitation_sent_users)): ?>
            ...
            <tr>
              ...
              <td><?php echo e($other_party_invited_user['created_record_date']); ?></td>
                            ...
                            <button class="btn btn-success">User Registered</button>
                            <?php else: ?>
               <button class="btn btn-danger" value="#">Not Registered</button>
              <?php endif; ?> 
                </td>
...
<?php echo $__env->make('frontend.manager.layouts.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>