...
Business Employee-Client Management
		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="<?php echo e(url('employee/create-client')); ?>" class="btn btn-info pull-right">
					 Create New Client
				 </a>
			 ...
			 <div class="box-body">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						<?php $__currentLoopData = $all_software_manager_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managers_client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<?php endif; ?>
							<td>
							 <a href="<?php echo e(url('employee/client-details/'.Hashids::encode($managers_client->client_id))); ?>" class="btn btn-warning" title="Details">
								 <span class="glyphicon glyphicon-folder-open"></span>
							</a>
							<!--  <a href="<?php echo e(url('employee/edit-client/'.Hashids::encode($managers_client->client_id))); ?>" class="btn btn-info" title="Edit">
...
<script>
	var url = "<?php echo e(url('employee/delete-client')); ?>";
