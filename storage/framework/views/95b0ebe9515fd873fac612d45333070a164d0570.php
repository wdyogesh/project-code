		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<?php endif; ?>
					<form action="<?php echo e(url('manager/store-other-party')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
						...
						<div class="modal-body">
                            ...
                            <div class="form-group" align="center">
								<a href="<?php echo e(url('manager/manage-other-parties')); ?>" class="btn btn-info">
									Go back
								</a>
