...
<head>
  ...
  <title><?php echo $__env->yieldContent('admin-title'); ?></title>
  ...
  <style>
    ...
    <?php echo $__env->yieldContent('admin-pagelevel-styles'); ?>
</head>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
               ...
               <form action="<?php echo e(url('admin/edit-profile-picture')); ?>" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
...
<?php echo $__env->yieldContent('admin-pagelevel-script'); ?>
