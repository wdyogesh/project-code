		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<?php endif; ?>
					<form action="<?php echo e(url('client/create-notes')); ?>" class="-bootstrap-modal-form form-horizontal" method="post" enctype="multipart/form-data">
