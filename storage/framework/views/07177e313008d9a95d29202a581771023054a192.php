		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Create Other Party Category</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<?php endif; ?>
					<form action="<?php echo e(url('manager/store-other-party-category')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
						...
						<div class="modal-body">
							...
							<div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Category Name" name="category_name" value="<?php echo e(old('category_name')); ?>" maxlength="25">
