...
<title>Intell-Comm-Re-Set Password</title>
...
<div class="login-form">
  ...
  <div class="row">
   ...
   <?php endif; ?> 
   <form action="<?php echo e(url('user-re-set-password')); ?>" class="-bootstrap-modal-form" method="post">
    ...
    <div class="form-group">
     <input type="password" name="confirm_password" class="form-control" placeholder="Confirm Password" maxlength="10">
    </div>
    <input type='hidden' name='user_id' value="<?php echo e($user_record['id']); ?>" class="form-control"/>
    <input type='hidden' name='request_id' value="<?php echo e($request_id); ?>" class="form-control"/>
