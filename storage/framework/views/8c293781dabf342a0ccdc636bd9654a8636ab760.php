        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                   ...
                   <?php endif; ?>
                   <form action="<?php echo e(url('employee/store-client')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-5">
                    ...
                    <span class="text-danger"><?php echo e($errors->first('country_code')); ?></span>
                            ...
                            <div class="col-sm-5">
                            <textarea class="form-control" rows="3" placeholder="Enter Address..." name="address" maxlength="200"><?php echo e(old('address')); ?></textarea>
