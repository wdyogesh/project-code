...
Client-Account Settings-Profile
...
<?php $__env->startSection('content'); ?>
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url('client/dashboard')); ?>">Dashboard</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <?php endif; ?>
            <form action="<?php echo e(url('client/edit-profile')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
              ...
              <div class="modal-footer">
                <a href="<?php echo e(url('client/profile')); ?>" class="btn btn-info pull-left">
               Go back
              </a>
