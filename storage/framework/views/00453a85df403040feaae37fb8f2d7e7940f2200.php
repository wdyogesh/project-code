...
<body>
  ...
  <div class="registration_section main">
   ...
   <?php endif; ?> 
    <form  action="<?php echo e(url('employee-login')); ?>" class="bootstrap-modal-form" method="post">
    ...
    <div class="learn_more_btn">
     <a href="<?php echo e(url('employee/forgot-password')); ?>">Forgotten account?</a>
    </div>
   </div>
    </form>
      </div>
