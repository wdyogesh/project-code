...
<?php $__env->startSection('content'); ?>
  <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url('manager/dashboard')); ?>">Dashboard</a></li>
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
             ...
             <?php endif; ?> 
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <h3 align="center"><b>Business Details</b></h3>
                </li>
                <li class="list-group-item">
                  <b>Business Name</b> <a class="pull-right"><?php echo e($user_profile['businessdetails']['businesss_name']); ?></a>
                </li>
                <li class="list-group-item">
                  <b>Business Type</b> <a class="pull-right"><?php echo e($user_profile['businessdetails']['business_type']); ?></a>
                </li>
              </ul>

              <a href="<?php echo e(url('manager/edit-profile/'.Hashids::encode($user_profile['id']))); ?>" class="btn btn-primary btn-block"><b>Edit</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
