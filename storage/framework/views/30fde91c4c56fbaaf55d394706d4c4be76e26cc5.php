       ...
       <?php echo $__env->make('frontend.business-manager.mail-box-management.message-sidebar-lables', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Draft Box</h3>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                  <?php $__currentLoopData = $draft_messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft_message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                   <td>
                   <input type="checkbox" name="selected[]" value="<?php echo e($draft_message->master_table_email_id); ?>">
                   </td>
                    <td>
                     <a href="<?php echo e(url('manager/important',$draft_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($draft_message->email_table_id != ""): ?> text-yellow <?php endif; ?>"></i></a>
                    </td>
                    <td class="mailbox-name"><a href="<?php echo e(url('manager/read-message-details/'.Hashids::encode($draft_message->master_table_email_id).'/'. Hashids::encode(4) )); ?>" title="Subject"><?php echo e($draft_message->subject); ?></a></td>

                     

                    <td class="mailbox-subject"><b title="Message"><?php echo str_limit($draft_message->message,120); ?></b>
                    </td>
                    <?php if(!empty($draft_message->attachments)): ?>
                    <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                    <?php else: ?>
                    <td class="mailbox-attachment"></i></td>
                    <?php endif; ?>
                    <td class="mailbox-date"><?php echo e($draft_message->date); ?></td>
