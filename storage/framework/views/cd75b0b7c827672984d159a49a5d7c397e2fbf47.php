...
Business Manager-Apoointments
<?php $__env->stopSection(); ?>
<?php $__env->startSection('pagelevel-styles'); ?>
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
<!-- <link rel="stylesheet" href="<?php echo e(asset('dist/jquery.yacal.css')); ?>">
 -->
 <style>
 .fc-center{
    margin-left:600px;
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-xs-8" style="float: right;">
            ...
            <div class="col-xs-1">
                <a href="<?php echo e(url('manager/appointments/'.Hashids::encode(1))); ?>" class="btn <?php echo e(Request::is('manager/appointments') || Request::is('manager/appointments/'.Hashids::encode(1))? 'btn-warning' : 'btn-info'); ?>">
              1 Day
               </a>
            </div>
            <div class="col-xs-1">
              <a href="<?php echo e(url('manager/appointments/'.Hashids::encode(3))); ?>" class="btn <?php echo e(Request::is('manager/appointments/'.Hashids::encode(3))? 'btn-warning' : 'btn-info'); ?>">
                  3 Days
              </a>
            </div>

            <div class="col-xs-1">
               <a href="<?php echo e(url('manager/appointments/'.Hashids::encode(6))); ?>" class="btn <?php echo e(Request::is('manager/appointments/'.Hashids::encode(6))? 'btn-warning' : 'btn-info'); ?>">
                  6 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="<?php echo e(url('manager/appointments/'.Hashids::encode(7))); ?>" class="btn <?php echo e(Request::is('manager/appointments/'.Hashids::encode(7))? 'btn-warning' : 'btn-info'); ?>">
                  7 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="<?php echo e(url('manager/appointments/'.Hashids::encode(5))); ?>" class="btn <?php echo e(Request::is('manager/appointments/'.Hashids::encode(5))? 'btn-warning' : 'btn-info'); ?>">
                  Work Week
              </a>
            </div>
      </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" style="">
          <div>    <!-- //start form -->
            <form action="<?php echo e(url('manager/store-appointment')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
             <?php echo e(csrf_field()); ?>

             <div class="modal-body">
              <div class="box-body" style="margin-top: -104px;">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-8">
                  <select class="form-control select2" name="employee_practitioner_id" style="width: 100%;">
                    ...
                    <option value="<?php echo e($practitioner->id); ?>"><?php echo e($practitioner['email']); ?>[<?php echo e($practitioner->name); ?>]</option>
              ...
              <div class="form-group" id="client_dropdown">
                 ...
                 <div class="col-sm-8">
                  <select class="form-control select2" name="client_id" style="width: 100%;">
                    ...
                    <option value="<?php echo e($managers_client->id); ?>"><?php echo e($managers_client['email']); ?>[<?php echo e($managers_client->name); ?>]</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>             
              </div>
             ...
             <div style="display: none" id="clint_registration_fields">
              ...
              <div class="form-group">
                 ...
                 <div class="col-sm-8">
                 <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Sur Name" name="surname" value="<?php echo e(old('surname')); ?>" maxlength="30">
                </div>
              </div>
              <div class="form-group">
             ...
             <div class="form-group">
               <label for="inputEmail3" class="col-sm-4 control-label">Date of birth:</label>
                <div class="col-sm-8">
                  <input onchange="checkDate()" type="text" class="form-control" id="datepicker4" placeholder="Select Date" name="dateof_birth" value="<?php echo e(old('dateof_birth')); ?>" maxlength="15" onkeypress="return isNumberKey(event)" data-date-format="mm/dd/yyyy">
                  <p id="date_of_birth_error"><span class="text-danger"><!-- <?php echo e($errors->first('dateof_birth')); ?> --></span></p>
                </div>
            </div>
            </div>
             ...
             <label style="color:green;"> <input type="checkbox" id="coupon_question" name="checkbox" value="1"/>Do you want to register new client?</label>
              ...
              <div class="form-group">
               <label for="inputEmail3" class="col-sm-4 control-label">Appointment Date:</label>
                <div class="col-sm-8">
                  <input onchange="appointmentDate()" type="text" class="form-control" id="datepicker" placeholder="Select Date" name="appointment_date" value="<?php echo e(old('appointment_date')); ?>" maxlength="15" onkeypress="return isNumberKey(event)">
                    <p id="date_of_appointment_error"><span class="text-danger"><!-- <?php echo e($errors->first('dateof_birth')); ?> --></span></p>
                </div>
            </div>
            ...
            <div class="bootstrap-timepicker">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                 <input type="text" class="form-control timepicker" id="start_time" placeholder="Enter Start Time" name="start_time" value="<?php echo e(old('start_time')); ?>">
              </div>
            </div>
            ...
            <div class="bootstrap-timepicker">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control timepicker" id="inputEmail3" placeholder="Enter End Time" name="end_time" value="<?php echo e(old('end_time')); ?>">
                </div>
                </div>

              

                <input type="hidden" name="manager_id" value="<?php echo e(Auth::user()->id); ?>">
               <div class="form-group" align="center">
                <button type="submit" class="btn btn-info" id="submit">Book</button>
              </div>
              </div>       
            </div>
          </div>
          <input type="hidden" id="business_start_time" name="business_start_time" value="<?php echo e($business_start_time); ?>">
          <input type="hidden" id="business_end_time" name="business_end_time" value="<?php echo e($business_end_time); ?>">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-6">
               <h5 id="modalStartTime" class="modal-starttime"></h5>
                <b>to</b> 
               <h5 id="modalEndTime" class="modal-endtime"></h5>
             </div>
           </div><br>
           ...
           <div class="form-group">
             <div class="col-sm-12">    
              ...
              <button type="button" class="btn btn-default arrived" id="appointment_id_for_arrived_check" style="">Arrived</button>

              <button type="button" class="btn btn-default dna" id="appointment_id_for_dna_check">DNA</button> 

              <button type="button" class="btn btn-default inprocess" id="appointment_id_for_inprocess_check">In process</button>

              <button type="button" class="btn btn-default seen" id="appointment_id_for_seen_check">Seen</button> 
    ...
    <div id="record-edit" style="display: none">  
      ...
      <div class="modal-body">
        <div id="view-show" class="box-body">
          <form action="<?php echo e(url('manager/update-appointment')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
            <?php echo e(csrf_field()); ?>
            ...
            <div class="form-group">
             ...
             <div class="col-sm-8">
              <select id="option_client" class="form-control" name="client_id" style="width: 100%;">
                <option value="">Select Client</option>
                <?php $__currentLoopData = $managers_clients_edit_page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managers_client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($managers_client->id); ?>"><?php echo e($managers_client->email); ?>[<?php echo e($managers_client->name); ?>]</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
...
" class="text-danger"><!-- <?php echo e($errors->first('dateof_birth')); ?> --></span></p>
          </div>
...
<script>
  var deleteurl = "<?php echo e(url('manager/delete-appointment')); ?>";
  var editurl = "<?php echo e(url('manager/edit-client-appointment')); ?>";
  var access_client_hash_id = "<?php echo e(url('manager/client-id')); ?>";
  var redirect_url= "<?php echo e(url('manager/client-details')); ?>";
  var appointment_page_url= "<?php echo e(url('manager/appointments')); ?>";
  var arrived_url= "<?php echo e(url('manager/client-arrived-check')); ?>";
  var dna_url= "<?php echo e(url('manager/client-dna-check')); ?>";
  var in_process_url= "<?php echo e(url('manager/client-in-process-check')); ?>";
  var seen_url= "<?php echo e(url('manager/client-seen-check')); ?>";
  ...
  $(document).on('click','.client-details',function(){
      ...
      $.ajax({
        type: "get",
        url: access_client_hash_id + '/' + appointment_id,         
        success: function (data) {
         //alert(data);
  ...
  //appointment check status(all arrived,dna and all... start)
  $(document).on('click','#appointment_id_for_arrived_check',function(){
      var appointment_id = $(this).val();
       //alert(appointment_id);
      $.ajaxSetup({
        headers: {
      ...
      $.ajax({
        type: "get",
        url: arrived_url + '/' + appointment_id,         
        success: function (data) {
          window.location.href = appointment_page_url;         
          },
          error: function (data) {
            console.log('Error:', data);
          }
  ...
  $(document).on('click','#appointment_id_for_dna_check',function(){
      var appointment_id = $(this).val();
       //alert(appointment_id);
      $.ajaxSetup({
        headers: {
  ...
  $(document).on('click','#appointment_id_for_inprocess_check',function(){
      var appointment_id = $(this).val();
       //alert(appointment_id);
      $.ajaxSetup({
        headers: {
      ...
      $.ajax({
        type: "get",
        url: in_process_url + '/' + appointment_id,         
        success: function (data) {
          window.location.href = appointment_page_url;         
          },
          error: function (data) {
  ...
  $(document).on('click','#appointment_id_for_seen_check',function(){
      var appointment_id = $(this).val();
       //alert(appointment_id);
      $.ajaxSetup({
        headers: {
 ...
 //appointment check status(all arrived,dna and all... end)
