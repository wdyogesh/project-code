...
Business Employee-All Attachments
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <?php echo e($client_record['name']); ?> <?php echo e($client_record['surname']); ?> / Attachments
      </h1>
     <a href="<?php echo e(url('employee/attach-file/'.Hashids::encode($client_record['id']))); ?>" class="btn btn-info pull-right">Add</a>
    </section>
          ...
          <div class="box box-primary">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu scrollable-menu" role="menu">
                 <li><a href="<?php echo e(url('employee/client-attachments/'.Hashids::encode($client_record['id']))); ?>">All</a></li>
               ...
               <?php $__currentLoopData = $fileter_attachment_headings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li><a href="<?php echo e(url('employee/client-attachments/'.Hashids::encode($client_record['id']).'/'.$attachment['heading'])); ?>"><?php echo e($attachment['heading']); ?></a></li>
            ...
            <tr>
              ...
              <td>
                 <?php if($attachment['common_user_id'] == Auth::user()->id): ?>
                  <a href="<?php echo e(url('employee/edit-attachment/'.Hashids::encode($attachment['id']).'/'.Hashids::encode($client_record['id']))); ?>" class="btn btn-info">
                   Edit
                 </a>
...
<script src="<?php echo e(asset('js/login-bootstrap-modal-form.js')); ?>"></script>
<script>
var url = "<?php echo e(url('employee/delete-attachment')); ?>";
