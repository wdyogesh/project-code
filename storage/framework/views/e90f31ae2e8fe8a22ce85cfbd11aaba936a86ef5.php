...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
      <h1>
       Mr <?php echo e($client_record['name']); ?> <?php echo e($client_record['surname']); ?> / Client details
         ...
         <a href="<?php echo e(url('employee/edit-client/'.Hashids::encode($client_record['id']))); ?>" class="btn btn-info pull-right">
           Edit
         </a>
    </section>
 ...
 -->
        ...
        <div class="col-md-9">
      	...
      	<form action="<?php echo e(url('employee/update-employee')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
