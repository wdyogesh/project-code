...
<?php $__env->startSection('content'); ?>
 ...
 -->
      ...
      <form action="<?php echo e(url('manager/update-client')); ?>" class="bootstrap-modal-form form-horizontal" method="post">
                  ...
                  <div class="col-sm-5">
                    ...
                    <span class="text-danger"><?php echo e($errors->first('country_code')); ?></span>
                         ...
                         <!--    <div class="form-group">
                            ...
                            <div class="col-sm-5">
                            <textarea class="form-control" rows="3" placeholder="Enter Address..." name="address" maxlength="200"><?php echo e($managers_client_record['address']); ?></textarea>
