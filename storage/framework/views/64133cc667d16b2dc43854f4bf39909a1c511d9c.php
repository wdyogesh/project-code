...
<?php $__env->startSection('content'); ?>
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      ...
      <?php endif; ?>   
            <!-- /.box-header -->
         <form action="<?php echo e(url('manager/add-group')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
            ...
            <div class="modal-body">
              <div class="box-body">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Name" name="group_name" value="<?php echo e(old('group_name')); ?>">
                ...
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Group Email</label>
                   <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Email" name="email" value="<?php echo e(old('email')); ?>" maxlength="30">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="form-control" id="employee" name="employee[]"  multiple="multiple">
                                     ...
                                     <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->email); ?>[<?php echo e($employee->name); ?> <?php echo e($employee->surname); ?>]</option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                    <span class="text-danger"><?php echo e($errors->first('employee')); ?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="form-control" id="otherparties" name="otherparties[]"  multiple="multiple">
                                     <?php $__currentLoopData = $other_parties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other_party): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($other_party->id); ?>"><?php echo e($other_party->email); ?>[<?php echo e($other_party->name); ?> <?php echo e($other_party->surname); ?>]</option>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    <span class="text-danger"><?php echo e($errors->first('otherparties')); ?></span>
                  </div>
                </div>
                
                            <div class="form-group" align="center">
                  <a href="<?php echo e(url('manager/manage-group')); ?>" class="btn btn-info">Go Back</a>
