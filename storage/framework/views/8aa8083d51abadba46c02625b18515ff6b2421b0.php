...
<head>
  ...
  <title>Intell-Comm Other Party Login</title>
   ...
   <div class="container">
    <div class="login-form">
      ...
      <?php endif; ?>
       ...
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 <h1>Business other party login</h1>
     <?php if($errors->any()): ?>
   ...
   <?php endif; ?> 
    <form  action="<?php echo e(url('other-party-login')); ?>" class="bootstrap-modal-form" method="post">
    ...
    <div class="form-group">
     <?php if(!empty($user_email)): ?>
      <input type="text" class="form-control" value="<?php echo e($user_email['email']); ?>" id="email" name="email" placeholder="Email" readonly>
      <?php else: ?>
    ...
    <div class="learn_more_btn">
     <a href="<?php echo e(url('other-party/forgot-password')); ?>">Forgotten account?</a>
    </div>
   </div>
    </form>
      </div>
