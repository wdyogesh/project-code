                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($important_message->email_table_id); ?>">
                    ...
                    <td>
                     <a href="<?php echo e(url('manager/important',$important_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($important_message->email_table_id != ""): ?> text-yellow <?php endif; ?>"></i></a>
                    </td>
                    <td class="mailbox-name"><a href="<?php echo e(url('manager/read-message-details/'.Hashids::encode($important_message->master_table_email_id).'/'. Hashids::encode(6) )); ?>" title="Subject"><?php echo e($important_message->subject); ?></a></td>
