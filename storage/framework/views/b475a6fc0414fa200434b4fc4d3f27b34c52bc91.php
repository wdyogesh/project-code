...
<?php $__env->startSection('admin-content'); ?>
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo e(url('admin/read-message-details/'.Hashids::encode($message_id).'/'. Hashids::encode($page_name_dummy_number) )); ?>" class="btn btn-primary btn-block margin-bottom">Go Back</a>
        ...
        <div class="col-md-9" style="max-height: 550px;overflow-y: scroll;">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('admin/reply-message-post')); ?>" class="-bootstrap-modal-form" method="post" enctype="multipart/form-data">
