        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-2">
              <a href="<?php echo e(url('employee/manage-group')); ?>" class="btn  btn-block margin-bottom" style="background-color: #555555;"><span class="fa fa-users">Add Group</span></a>
              </div>
              <div class="col-md-2">
              <a href="<?php echo e(url('employee/compose-message/all')); ?>" class="btn <?php echo e(Request::is('employee/compose-message/all')? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope"></span> All</a>
              </div>
              <div class="col-md-2">
               <div class="dropdown">
               <button class="btn <?php echo e(Request::is('employee/compose-message/em') || Request::is('employee/compose-message/em-admin') || Request::is('employee/compose-message/em-reception') || Request::is('employee/compose-message/em-operational') || Request::is('employee/compose-message/em-facetoface')? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope">Employees</span></button>
              <div class="dropdown-content">
                <a href="<?php echo e(url('employee/compose-message/em')); ?>">=> All</a>
                <a href="<?php echo e(url('employee/compose-message/em-admin')); ?>">=> Admin</a>
                <a href="<?php echo e(url('employee/compose-message/em-reception')); ?>">=> Reception</a>
                <a href="<?php echo e(url('employee/compose-message/em-operational')); ?>">=> Operational</a>
                <a href="<?php echo e(url('employee/compose-message/em-facetoface')); ?>">=> Face to face</a>
              </div>
            </div>
              </div> 
              <div class="col-md-2">
             <!--  <a href="<?php echo e(url('employee/compose-message/cl')); ?>" class="btn <?php echo e(Request::is('employee/compose-message/cl')? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope"></span> Clients</a> -->
             <div class="dropdown">
               <button class="btn <?php echo e(Request::is('employee/compose-message/cl') || Request::is('employee/compose-message/cl/*') ? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope">Clients</span></button>
              <div class="dropdown-content">
                <a href="<?php echo e(url('employee/compose-message/cl')); ?>">=> All</a>
                ...
                <?php $__currentLoopData = $notes_categores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notes_categore): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <a href="<?php echo e(url('employee/compose-message/cl/'.Hashids::encode($notes_categore->id))); ?>">=> <?php echo e($notes_categore->category_name); ?></a>
              ...
              <div class="col-md-2">
            <!--   <a href="<?php echo e(url('employee/compose-message/ot')); ?>" class="btn <?php echo e(Request::is('employee/compose-message/ot')? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope"></span> Other Party</a> -->
             <div class="dropdown">
               <button class="btn <?php echo e(Request::is('employee/compose-message/ot') || Request::is('employee/compose-message/ot/*') ? 'btn-warning' : 'btn-default'); ?>"><span class="fa fa-envelope">Other Party</span></button>
              <div class="dropdown-content">
                <a href="<?php echo e(url('employee/compose-message/ot')); ?>">=> All</a>
                ...
                <?php $__currentLoopData = $other_party_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other_party_categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <a href="<?php echo e(url('employee/compose-message/ot/'.Hashids::encode($other_party_categorie->id))); ?>">=> <?php echo e($other_party_categorie->category_name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              </div>
            </div>
               ...
               <div class="col-md-2">
                <a href="<?php echo e(url('employee/compose-message')); ?>" class="btn btn-default btn-sm" title="Refresh"><i class="fa fa-refresh"></i></a>
              </div>
            </div>
            <!-- /.box-header -->
          <form action="<?php echo e(url('employee/send-mail')); ?>" class="-bootstrap-modal-form" method="post" enctype="multipart/form-data">
