        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            <div class="box-header">
             ...
             <form action="<?php echo e(url('admin/subscription-limit-users')); ?>" class="-bootstrap-modal-form" method="post">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="package_name" value="<?php echo e(old('package_name')); ?>" placeholder="Enter Package Name">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="data_size" value="<?php echo e(old('data_size')); ?>" placeholder="Enter Data Size" >
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="user_size_from" value="<?php echo e(old('user_size_from')); ?>" placeholder="Users Count From" min="1">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="price" value="<?php echo e(old('price')); ?>" placeholder="Price">
