					...
					<?php if(isset($all_client_notes)): ?>
						...
						<tr>
                           ...
                           <?php endif; ?>
							...
							<?php endif; ?>
							<td>
							 <a href="<?php echo e(url('manager/note-details/'.Hashids::encode($notes['notes_id']))); ?>" class="btn btn-warning btn-detail open_modal" title="Details">
								<span class="glyphicon glyphicon-folder-open"></span>
							 </a>
							 <?php if($notes['role_name'] == 'Staff' || $notes['role_name'] == 'Clients'): ?>
							 <?php else: ?>
							 <a href="<?php echo e(url('manager/edit-notes/'.Hashids::encode($notes['notes_id']))); ?>" class="btn btn-info" title="Edit">
...
<script>
	var url = "<?php echo e(url('manager/delete-notes')); ?>";
