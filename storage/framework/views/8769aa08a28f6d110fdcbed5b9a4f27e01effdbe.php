...
<?php $__env->startSection('content'); ?>
 ...
 -->
     ...
     <form action="<?php echo e(url('employee/create-notes')); ?>" class="-bootstrap-modal-form form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="appointments">
                    ...
                    <?php $__currentLoopData = $apointment_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($appointment['appointment_id']); ?>"><?php echo e($appointment['appointment_date']); ?>[<?php echo e($appointment['client_name']); ?>]</option>
               ...
               <!--  <div class="form-group">                  
                ...
                <div class="col-sm-9">
                  <select class="form-control" name="other_party">
                    ...
                    <option value="<?php echo e($otherpartie['id']); ?>"><?php echo e($otherpartie['user_name']); ?> [<?php echo e($otherpartie['category_name']); ?>]</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </select>  
