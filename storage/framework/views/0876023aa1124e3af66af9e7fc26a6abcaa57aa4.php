...
<head>
	...
	<?php echo $__env->yieldContent('pagelevel-styles'); ?>
</head>
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">

		<?php echo $__env->make('frontend.business-manager.layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<!-- Left side column. contains the logo and sidebar -->
		<?php echo $__env->make('frontend.business-manager.layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			         ...
			         <form action="<?php echo e(url('manager/edit-profile-picture')); ?>" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
		...
		<!-- /.content-wrapper -->
		<?php echo $__env->make('frontend.business-manager.layouts.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->yieldContent('pagelevel-script'); ?>
