                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($sent_message->master_table_email_id); ?>">
                    ...
                    <td>
                    <a href="<?php echo e(url('admin/important',$sent_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($sent_message->email_table_id != ""): ?> text-yellow <?php endif; ?>"></i></a>
                    </td>
                    <td class="mailbox-name"><a href="<?php echo e(url('admin/read-message-details/'.Hashids::encode($sent_message->master_table_email_id).'/'. Hashids::encode(3) )); ?>" title="Subject"><?php echo e($sent_message->subject); ?></a></td>
