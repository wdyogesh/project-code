    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
		  ...
		  <?php endif; ?>   
            <!-- /.box-header -->
         <form action="<?php echo e(url('employee/edit-group')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Email" name="email" value="<?php echo e($record['email']); ?>">
                  ...
                  <div class="col-sm-3">
                    ...
                    <!-- <span class="text-danger"><?php echo e($errors->first('email')); ?></span> -->
                       ...
                       <option value="<?php echo e($employee->id); ?>"  <?php if($employee->selected_ids == 5): ?> check="checked" <?php endif; ?>><?php echo e($employee->email); ?>[<?php echo e($employee->name); ?> <?php echo e($employee->surname); ?>]</option>
