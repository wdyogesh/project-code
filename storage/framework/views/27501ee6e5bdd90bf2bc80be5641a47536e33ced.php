...
<div class="main">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <!--  <li><img src="<?php echo e(asset('frontpages/html/images/user_icon.png')); ?>"><a href="<?php echo e(url('manager-registration')); ?>">New Business User</a></li>
               <li>
               <img src="<?php echo e(asset('frontpages/html/images/registered_user.png')); ?>"><a href="<?php echo e(url('manager-login')); ?>">Login Business Users</a>
               </li> -->
  ...
  <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <div class="heading_fadd">
              <h1>Reliable , innovative solution for your business.</h1>
            </div>
    ...
    <div class="application_software_section">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>We are providing below <span>application Softwares</span></h3>
            <p>Considering just how fragile our health is as a species and how important it is to find diseases as early on as possible, we figured a nice lab for clinical Testing is what America needs now the most!</p>
            <div class="column-section col-lg-8 col-md-8 col-sm-12 col-xs-12">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon1.png')); ?>" >
                <h2>Business & Administration Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon2.png')); ?>" >
                <h2>Legal, Social and Cultural Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="clearfix"></div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon3.png')); ?>" >
                <h2>Health Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon4.png')); ?>" >
                <h2>Science and Engineering Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="clearfix"></div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon5.png')); ?>" >
                <h2>Teaching Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="<?php echo e(asset('frontpages/html/images/professional_icon6.png')); ?>" >
                <h2>Information & Communications Technology Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="clearfix"></div>
    ...
    <div class="our_team_section">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 "> <img src="<?php echo e(asset('frontpages/html/images/affordable.png')); ?>" />
              <h2>Affordable</h2>
              <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint...</p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 "> <img src="<?php echo e(asset('frontpages/html/images/free_trial.png')); ?>">
              <h2>1 Month free trial</h2>
              <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint...</p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 "> <img src="<?php echo e(asset('frontpages/html/images/cancel_anytime.png')); ?>">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 registration_process_section_left">
              <div class="register_business">
                <div class="register_business_left"> <img src="<?php echo e(asset('frontpages/html/images/business_man.png')); ?>"> </div>
              ...
              <div class="register_business">
                <div class="register_business_left"> <img src="<?php echo e(asset('frontpages/html/images/client_registration.png')); ?>"> </div>
                <div class="register_business_right">
              ...
              <div class="register_business">
                <div class="register_business_left"> <img src="<?php echo e(asset('frontpages/html/images/third_party_registration.png')); ?>"> </div>
                <div class="register_business_right">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding_appointment">
              <div class="appointement_section">
                <div class="appointement_section_left"> <img src="<?php echo e(asset('frontpages/html/images/appointement_system.png')); ?>"> </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="appointement_section">
                <div class="appointement_section_left"> <img src="<?php echo e(asset('frontpages/html/images/notes_document.png')); ?>"> </div>
                <div class="appointement_section_right">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 our_services_section_left"> <img src="<?php echo e(asset('frontpages/html/images/services_intelCOMM.png')); ?>" style="width:100%;"> <span>effective communication tool for your business. </span> </div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 our_services_section_right"> <img src="<?php echo e(asset('frontpages/html/images/services_img_right.png')); ?>" style="width:100%;"> </div>
          </div>
        </div>
      </div>
    </div>
