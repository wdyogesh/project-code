    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
		  ...
		  <?php endif; ?>   
            <!-- /.box-header -->
         <form action="<?php echo e(url('employee/add-group')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Email" name="email" value="<?php echo e(old('email')); ?>">
                   ...
                   <div class="col-sm-3">
                    ...
                    <!-- <span class="text-danger"><?php echo e($errors->first('email')); ?></span> -->
                            ...
                            <div class="form-group" align="center">
							    <a href="<?php echo e(url('employee/manage-group')); ?>" class="btn btn-info">Group Back</a>
