         ...
         <div class="container">
          <div class="row">
           <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-6  col-sm-offset-6">
            ...
            <form class="bootstrap-modal-form" action="<?php echo e(url('other-party-registration')); ?>" method="post" files='true'>
          ...
          <?php endif; ?>
            <?php echo e(csrf_field()); ?>
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type=text name='business_name' class="form-control" id="textname" maxlength="40" value="<?php echo e($business_name['businesss_name']); ?>" readonly>
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type=text name='invetation_category' class="form-control" id="textname" maxlength="40" value="<?php echo e($invitation_category['category_name']); ?>" readonly>
              </div>
             </div>
            ...
            <input type="hidden" name="manager_id" value="<?php echo e($other_party_details['manager_id']); ?>">  
            <input type="hidden" name="invitation_id" value="<?php echo e($invitation_id); ?>">
