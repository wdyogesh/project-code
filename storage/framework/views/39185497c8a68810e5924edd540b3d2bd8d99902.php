 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?php echo e(url('admin/compose-message')); ?>" class="btn btn-primary btn-block margin-bottom">Compose</a>
      ...
      <form method="post" action="<?php echo e(url('admin/trash')); ?>">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!--  <div class="col-md-2">
               <a href="<?php echo e(url('admin/mail-box')); ?>" class="btn <?php echo e(Request::is('admin/mail-box/*')? 'btn-primary' : 'btn-warning'); ?>"><span class="fa fa-envelope"></span> All</a>
             </div>
             <div class="col-md-2">
              <a href="<?php echo e(url('admin/mail-box/ad')); ?>" class="btn <?php echo e(Request::is('admin/mail-box/ad')? 'btn-warning' : 'btn-primary'); ?> btn-block margin-bottom"><span class="fa fa-envelope"></span> Admin</a>
              </div>
              <div class="col-md-2">
              <a href="<?php echo e(url('admin/mail-box/em')); ?>" class="btn <?php echo e(Request::is('admin/mail-box/em')? 'btn-warning' : 'btn-primary'); ?> btn-block margin-bottom"><span class="fa fa-envelope"></span> Employees</a>
              </div> 
              <div class="col-md-2">
              <a href="<?php echo e(url('admin/mail-box/cl')); ?>" class="btn <?php echo e(Request::is('admin/mail-box/cl')? 'btn-warning' : 'btn-primary'); ?> btn-block margin-bottom"><span class="fa fa-envelope"></span> Clients</a>
              </div>
              <div class="col-md-2">
               <a href="<?php echo e(url('admin/mail-box/ot')); ?>" class="btn <?php echo e(Request::is('admin/mail-box/ot')? 'btn-warning' : 'btn-primary'); ?> btn-block margin-bottom"><span class="fa fa-envelope"></span> Other Party</a>
              </div> -->
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($inbox_message->master_table_email_id); ?>">
                    ...
                    <td>
                    <a href="<?php echo e(url('admin/important',$inbox_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($inbox_message->user_id != ""): ?> text-yellow <?php endif; ?>"></i></a></td>

                    <td class="mailbox-name"><a href="<?php echo e(url('admin/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'.Hashids::encode(1) )); ?>" title="Subject"><?php echo e($inbox_message->subject); ?></a></td>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo e($inbox_message->master_table_email_id); ?>">
                    ...
                    <td>
                     <a href="<?php echo e(url('admin/important',$inbox_message->master_table_email_id)); ?>"><i style="color:#999" class="fa fa-star <?php if($inbox_message->email_table_id != ""): ?> text-yellow <?php endif; ?>"></i></a></td>
                    </td>
                    <td class="mailbox-name"><a href="<?php echo e(url('admin/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'. Hashids::encode(2) )); ?>" title="Subject"><?php echo e($inbox_message->subject); ?></a></td>
