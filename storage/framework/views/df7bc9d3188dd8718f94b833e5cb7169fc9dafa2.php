      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <?php endif; ?>
            <form action="<?php echo e(url('admin/edit-profile')); ?>" class="-bootstrap-modal-form form-horizontal" method="post">
              ...
              <div class="modal-footer">
                <a href="<?php echo e(url('admin/profile')); ?>" class="btn btn-info pull-left">
               Go back
              </a>
