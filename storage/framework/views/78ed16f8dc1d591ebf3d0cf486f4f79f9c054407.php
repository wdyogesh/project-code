...
<head>
  ...
  <title>Intell-Comm Client Remember Security Question</title>
...
<body>
  ...
  <div class="registration_section main">
   <div class="container">
    ...
    <form class="bootstrap-modal-form" action="<?php echo e(url('client/check-security-question-answer')); ?>" method="post" files='true'>
    ...
    <div class="form-group" style='display:none;' id='security_question_answer'>
     ...
     <input type='hidden' name='client_id' value="<?php echo e($client_id); ?>" class="form-control"/>
