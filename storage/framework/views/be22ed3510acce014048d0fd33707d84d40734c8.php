          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                 <form <?php if($dummy_page_wise_numbers == 5): ?> action="<?php echo e(url('other-party/detail-message-perminant-delete')); ?>" <?php else: ?> action="<?php echo e(url('other-party/detail-message-trash')); ?>"<?php endif; ?> method="post">
                  ...
                  <!--  <a href="<?php echo e(url('client/employee-reply-message/'.Hashids::encode($message_record_detail['id']).'/'. Hashids::encode($dummy_page_wise_numbers) )); ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Reply"><i class="fa fa-reply"></i></a> -->
