...
<head>
  ...
  <title>Intell-Comm Client Forgot Password</title>
...
<body>
  ...
  <div class="registration_section main">
   <div class="container">
    ...
    <form  action="<?php echo e(url('client/forgot-password')); ?>" class="bootstrap-modal-form" method="post">
    ...
    <div class="form-group">
      <input type="text" class="form-control" value="<?php echo e(old('email')); ?>" name="email" placeholder="Email">
    </div>
    <div class="learn_more_btn">
      <button type="submit" class="btn btn-success">Submit</button>
    </div>
      <div class="learn_more_btn">
      <a href="<?php echo e(url('client-login')); ?>" style="color:#8a6d3b">Do you want to go login?</a>
    </div><br>
    <!-- <div class="learn_more_btn">
      <a href="#" style="color:#3c763d">If you don't remember the e-mail address, contact your business manager</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div> -->
    <div class="learn_more_btn">
      <!-- <a href="<?php echo e(url('manager-registration')); ?>">Do you want to register?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="<?php echo e(url('manager/forgot-password')); ?>">Forgotten account?</a> -->
    </div>
   </div>
    </form>
      </div>
