...
Employee-Account Settings-Profile
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
             ...
             <?php endif; ?> 
              ...
              <a href="<?php echo e(url('employee/edit-profile',Hashids::encode($user_profile['id']))); ?>" class="btn btn-primary btn-block"><b>Edit</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
