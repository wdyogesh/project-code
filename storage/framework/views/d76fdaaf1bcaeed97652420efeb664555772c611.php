        ...
        <form  action="#" class="bootstrap-modal-form" method="post">
          <div class="login-form-section" style="padding: 28px;">
           ...
           <div class="learn_more_btn">
            <a href="<?php echo e(url('manager-login')); ?>" class="btn btn-success">Manager</a>
          </div>
          
           <div class="learn_more_btn">
            <a href="<?php echo e(url('employee-login')); ?>" class="btn btn-success">Employee</a>
          </div>

          <div class="learn_more_btn">
            <a href="<?php echo e(url('other-party-login')); ?>" class="btn btn-success">Other Party</a>
          </div>

           <div class="learn_more_btn">
            <a href="<?php echo e(url('client-login')); ?>" class="btn btn-success">Client</a>
          </div>
          
            <!--  <div class="learn_more_btn">
              <a href="<?php echo e(url('manager-registration')); ?>">Don’t yet have a IntellCOMM account? Register now!</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
           -->
          </div>
        </form>
