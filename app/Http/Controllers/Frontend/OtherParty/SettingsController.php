...
class SettingsController extends Controller {
	...
	public function profile(){ 
		...
		return view('frontend/other-party/other-party-settings/profile',compact('user_profile','user_role'));
	}
	...
	public function editProfile($subdomain,$hashid){ 
       ...
       return view('frontend/other-party/other-party-settings/edit-profile',compact('user_profile','countries','selected_countery_all_states_foreah','selected_state_all_cities_foreah'));
	}
	...
	public function changePassword(){ 
		...
		return view('frontend/other-party/other-party-settings/change-password');
	}
