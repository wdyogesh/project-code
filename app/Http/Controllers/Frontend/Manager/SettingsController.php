...
class SettingsController extends Controller {
	...
	public function profile(){ 
		...
		return view('frontend/business-manager/manager-settings/profile',compact('user_profile','user_role'));
	}

	public function editProfile($subdomain,$hashid){ 
        $manager_id = Hashids::decode($hashid)[0];
        $user_profile = User::with('businessdetails')->with('useraddresses')->whereId($manager_id)->first();
          //dd($user_profile);    
       ...
       return view('frontend/business-manager/manager-settings/edit-profile',compact('user_profile','countries','selected_countery_all_states_foreah','selected_state_all_cities_foreah'));
	}
	...
	public function changePassword(){ 
		...
		return view('frontend/business-manager/manager-settings/change-password');
	}
	...
	public function subscriptions(){ 
         $subscription_packages = SubscriptionUserLimit::all();
		return view('frontend/business-manager/manager-settings/subscriptions',compact('subscription_packages'));
	}
	...
	public function postSubscribe(Request $request){
      // return $request->all();
		...
		if ($validator->fails()){
		 ...
		 $data= $request->all();
		 Session::put('selected_package', $data); 
	     return redirect()->to('manager/addmoney/stripe');
		}
    ...
    public function settings(){
     return view('frontend/business-manager/manager-settings/settings');
    }
}
