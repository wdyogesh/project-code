...
class NoteController extends Controller {
    ...
    public function manageNotes($subdoamin,$hashclientid){
        ...
        $client_notes=ClientNotes::where('manager_id',$manager_id['manager_id'])->where('client_id',$client_id)->get();
        $data=[];  
        ...
        //dd($all_client_notes);
        return view('frontend/employee/notes/manage-notes',compact('all_client_notes','client_notes','client_record','client_id'));
    }
    ...
    public function searchNotes($subdoamin,Request $request){
        ...
        $client_notes= ClientNotes::where('manager_id',$manager_id['manager_id'])->where('client_id',$client_id)->where('consultation_type', 'LIKE', '%' . $search . '%')->get();
        }
        $data=[];  
        foreach($client_notes as $notes){
          $clients_record=User::where('id',$notes['client_id'])->select('name','surname')->first();
        ...
        //return $all_client_notes;
        //dd($all_client_notes);
        return view('frontend/employee/notes/ajax-manage-notes',compact('all_client_notes','client_notes','client_record'));
    }
    ...
    /*public function createNotes($subdoamin,$hashclientid){
        ...
        $notes_category=NotesCategory::where('manager_id',$manager_id['manager_id'])->where('soft_delete',0)->get();
        $other_party_users=RegisteredOtherParties::where('manager_id',$manager_id['manager_id'])->get();
        $data=[];
    	...
    	return view('frontend/employee/notes/create-client-notes',compact('managers_clients','notes_category','otherparties','client_record'));
    }*/
    ...
    public function createNotes($subdoamin,$hashclientid){
        ...
        $manager_id = Employee::where('employee_id',Auth::user()->id)->select('manager_id')->first();
        $client_record= User::where('id',$client_id)->first();
        $appointments= Appointments::where('client_id',$client_id)->where('manager_id',$manager_id['manager_id'])->where('cancellation','=',null)->get();
        $dt = Carbon::now();
        $appoint=[];
        ...
        return view('frontend/employee/notes/create-client-notes',compact('managers_clients','notes_category','otherparties','client_record','apointment_details'));
    }
   ...
   /* public function postNotes(Request $request){
		...
		if ($validator->fails()){
           ...
           $manager_id = Employee::where('employee_id',Auth::user()->id)->select('manager_id')->first();
			...
			$url = url('employee/notes/'.Hashids::encode($data['client_name']));
			if ($request->ajax()){
 ...
 /* public function editNotes($subdomain,$notesid,$hashclientid){
    $manager_id = Employee::where('employee_id',Auth::user()->id)->select('manager_id')->first();
       ...
       $client_record= User::where('id',$client_id)->first();
    	...
    	return view('frontend/employee/notes/edit-notes',compact('managers_clients','notes_category','notes','client_record'));
   }*/
   ...
   public function editNotes($subdomain,$notesid,$hashclientid){
       ...
       $appointments= Appointments::where('client_id',$client_id)->where('manager_id',$manager_id['manager_id'])->where('cancellation','=',null)->get();
        ...
        //return $otherparties;
        return view('frontend/employee/notes/edit-notes',compact('managers_clients','notes_category','notes','client_record','otherparties','apointment_details'));
   }
  ...
  /* public function updateNotes(Request $request){
    ...
    public function notesDetails($subdomain,$hasnoteshid,$hashclienthid){
    	...
    	$client_records=User::where('id',$notes['client_id'])->select('name','surname')->first();
	      ...
	      $data['created_record_date']=$notes['created_record_date'];
	      $data['updated_record_date']=$notes['updated_record_date'];
    	return view('frontend/employee/notes/detail-notes',compact('data','client_record'));
  }  
   ...
   public function attachments($subdomain,$hashclienthid,$hashcategoryid=NULL){
    	...
    	$client_id = Hashids::decode($hashclienthid)[0];
        $client_record= User::where('id',$client_id)->first();
    	$categories = NotesCategory::where('manager_id',$manager_id['manager_id'])->get();
        if($hashcategoryid != ""){
            $category_id = Hashids::decode($hashcategoryid)[0];
            $attachments= ClientNotes::where('client_id',$client_id)->where('category_name',$category_id)->where('manager_id',$manager_id['manager_id'])->where('file_name','<>','')->get();
        }else{
             $attachments= ClientNotes::where('client_id',$client_id)->where('manager_id',$manager_id['manager_id'])->where('file_name','<>','')->get(); 
        }   
        $data=[];
        foreach($attachments as $attachment){
            $category_record = NotesCategory::where('id',$attachment['category_name'])->where('manager_id',$manager_id['manager_id'])->first();
            $data['category_name']=$category_record['category_name'];
            $data['attachments']=$attachment['file_name'];
            $attachentsall[]=$data;
        }
    	return view('frontend/employee/notes/attachments',compact('categories','attachentsall','client_record'));
  }  
  ...
  public function appointments($subdomain,$hashclienthid){
       $manager_id = Employee::where('employee_id',Auth::user()->id)->select('manager_id')->first();
    	...
    	foreach($appointments as $appointment){
            ...
            $added_user=User::where('id',$appointment['manager_id'])->first();
            $data['added_by']=$added_user['name'];
            $my_appointments[]=$data;
    	}
    	//return $my_appointments;
    	return view('frontend/employee/notes/client-appointments',compact('my_appointments','client_record'));
  }  
