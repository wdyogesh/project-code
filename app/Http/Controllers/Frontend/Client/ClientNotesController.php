...
*/
    ...
    public function manageNotes(){
    	...
    	$client_notes=ClientNotes::where('client_id',Auth::user()->id)->where('manager_id',$manager_id['manager_id'])->get();
    	$data=[];
    	...
    	//dd($all_client_notes);
    	return view('frontend/client/client-notes/notes/manage-notes',compact('all_client_notes'));
    }

    public function createNotes(){
    	$manager_id = ManagerClients::where('client_id',Auth::user()->id)->select('manager_id')->first();
        $notes_category=NotesCategory::where('manager_id',$manager_id['manager_id'])->where('soft_delete',0)->get();
    	return view('frontend/client/client-notes/notes/create-client-notes',compact('notes_category'));
    }
  ...
  public function editNotes($subdomain,$hashid){
	 ...
	 // return $data;
    	return view('frontend/client/client-notes/notes/edit-notes',compact('managers_clients','notes_category','notes'));
   }
   ...
   public function updateNotes(Request $request){
    ...
    public function notesDetails($subdomain,$hashid){
    	...
    	$client_record=User::where('id',$notes['client_id'])->select('name','surname')->first();
		  ...
		  $data['category_name']=$category_record['category_name'];
		  $data['notes']=$notes['notes'];
		  $business_employee=User::where('id',$notes['employee_id'])->first();
	      ...
	      $data['updated_record_date']=$notes['updated_record_date'];
	 // return $data;
    	return view('frontend/client/client-notes/notes/detail-notes',compact('data'));
  }  
