          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
               ...
               <form action="{{url('admin/edit-profile-picture')}}" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
               {{ csrf_field() }}
