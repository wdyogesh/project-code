        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-2">
              <a href="{{url('admin/manage-group')}}" class="btn  btn-block margin-bottom" style="background-color: #555555;"><span class="fa fa-users">Add Group</span></a>
              </div>
              <div class="col-md-3">
              <a href="{{url('admin/compose-message/all')}}" class="btn {{ Request::is('admin/compose-message/all')? 'btn-warning' : 'btn-default'}}"><span class="fa fa-envelope"></span> All Business Clients</a>
              </div>
             <!--  <div class="col-md-2">
              <a href="{{url('admin/compose-message/em')}}" class="btn {{ Request::is('admin/compose-message/em')? 'btn-warning' : 'btn-default'}}"><span class="fa fa-envelope"></span> Staff</a>
              </div> 
              <div class="col-md-2">
              <a href="{{url('admin/compose-message/cl')}}" class="btn {{ Request::is('admin/compose-message/cl')? 'btn-warning' : 'btn-default'}}"><span class="fa fa-envelope"></span> Clients</a>
              </div>
              <div class="col-md-2">
              <a href="{{url('admin/compose-message/ot')}}" class="btn {{ Request::is('admin/compose-message/ot')? 'btn-warning' : 'btn-default'}}"><span class="fa fa-envelope"></span> Other Party</a>
              </div>-->
              <div class="col-md-2">
                <a href="{{url('admin/compose-message')}}" class="btn btn-default btn-sm" title="Refresh"><i class="fa fa-refresh"></i></a>
              </div> 
            </div>
            <!-- /.box-header -->
          <form action="{{url('admin/send-mail')}}" class="-bootstrap-modal-form" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
