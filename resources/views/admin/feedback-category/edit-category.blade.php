		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					@endif
					<form action="{{url('admin/edit-feedback-categories')}}" class="bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
						<div class="modal-body">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input class="form-control" name="category_name" placeholder="Category" value="{{$category['category_name']}}">
										<span class="text-danger">{{ $errors->first('category_name') }}</span>	
									</div>
								</div>
								<input type="hidden" name="category_id" value="{{$category['id']}}">
								<input type="hidden" name="category_hidden_name" value="{{$category['category_name']}}">
