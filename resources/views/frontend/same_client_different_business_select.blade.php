        ...
        <form  action="#" class="bootstrap-modal-form" method="post">
          ...
          @foreach($business_details as $key => $business_detail)
           <div class="learn_more_btn">
            <a href="{{route('client-login',[$business_detail['business_name']['businesss_name'],Hashids::encode($business_detail['client_id']['id'])])}}" class="btn btn-success">{{$business_detail['business_name']['businesss_name']}}</a>
          </div>
          @endforeach
          </div>
        </form>
