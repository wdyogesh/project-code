...
<div class="login-form">
  ...
  <div class="row">
   ...
   @endif 
    <form class="bootstrap-modal-form" action="{{url('set-security-question')}}" method="post" files='true'>
{{ csrf_field() }}
    ...
    <div class="form-group" style='display:none;' id='security_question_answer'>
     ...
     <input type='hidden' name='employee_or_staff_id' value="{{$employee_id}}" class="form-control"/>
