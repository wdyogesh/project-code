          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <!--  <li><img src="{{asset('frontpages/html/images/user_icon.png')}}"><a href="{{url('manager-registration')}}">New Business User</a></li>
               <li>
               <img src="{{asset('frontpages/html/images/registered_user.png')}}"><a href="{{url('manager-login')}}">Login Business Users</a>
               </li> -->
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="column-section col-lg-8 col-md-8 col-sm-12 col-xs-12">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon1.png')}}" >
                <h2>Business & Administration Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon2.png')}}" >
                <h2>Legal, Social and Cultural Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="clearfix"></div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon3.png')}}" >
                <h2>Health Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon4.png')}}" >
                <h2>Science and Engineering Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="clearfix"></div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon5.png')}}" >
                <h2>Teaching Professionals</h2>
                <p>Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.</p>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <img src="{{asset('frontpages/html/images/professional_icon6.png')}}" >
