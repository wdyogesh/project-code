		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="{{url('employee/create-client-notes')}}" class="btn btn-info pull-right">
					 Create
				 </a>
				...
				<table id="example1" class="table table-bordered table-striped">
					...
					@if(isset($all_client_notes))
						...
						<tr>
							...
							<td>{{$notes['added_by']}}<b>[{{$notes['role_name']}}]</b></td>
                           ...
                           @endif
							...
							@endif
							<td>
							 <a href="{{url('employee/note-details/'.Hashids::encode($notes['notes_id']))}}" class="btn btn-warning btn-detail open_modal" title="Details">
								<span class="glyphicon glyphicon-folder-open"></span>
							 </a>
							 @if($notes['role_name'] == 'Business Manager' || $notes['role_name'] == 'Clients')
							 @else
							 <a href="{{url('employee/edit-notes/'.Hashids::encode($notes['notes_id']))}}" class="btn btn-info" title="Edit">
...
<script>
	var url = "{{url('employee/delete-notes')}}";
