		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					@endif
					<form action="{{url('employee/update-client-notes')}}" class="-bootstrap-modal-form form-horizontal" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="modal-body">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control select2" name="client_name">
											...
											<option value="{{$managers_client->id}}" @if($notes['client_id'] == $managers_client->id) selected="select" @endif>{{$managers_client->name}}</option>
											@endforeach
										</select>  
									</div>
								...
								<div class="form-group" align="center">
									<a href="{{url('employee/manage-client-notes')}}" class="btn btn-info">
										Go back
									</a>
