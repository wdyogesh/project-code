		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="{{url('employee/create-client')}}" class="btn btn-info pull-right">
					 Create New Client
				 </a>
			 ...
			 <div class="box-body">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						@foreach($all_software_manager_clients as $managers_client)
						<tr>
							...
							@endif
							<td>
							 <a href="{{url('employee/client-details/'.Hashids::encode($managers_client->client_id))}}" class="btn btn-warning" title="Details">
								 <span class="glyphicon glyphicon-folder-open"></span>
							</a>
							<!--  <a href="{{url('employee/edit-client/'.Hashids::encode($managers_client->client_id))}}" class="btn btn-info" title="Edit">
...
<script>
	var url = "{{url('employee/delete-client')}}";
