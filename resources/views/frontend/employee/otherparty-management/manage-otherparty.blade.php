    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
         ...
         <a href="{{url('employee/other-party-registration-by-employee')}}" class="btn btn-info pull-right">
      ...
      <table id="example1" class="table table-bordered table-striped">
          ...
          @if(isset($main_other_party_register_users))
            ...
            <tr>
              ...
              <td>         
               <a href="{{url('employee/other-party-details',Hashids::encode($main_other_party_register_users['main_user_id']))}}" class="btn btn-warning" title="Details"><span class="glyphicon glyphicon-folder-open"></span></a>
              <!--  @if($main_other_party_register_users['other_party_active'] == 1)
               <a href="{{url('employee/other-party-activation/'.Hashids::encode($main_other_party_register_users['main_user_id']).'/'.Hashids::encode($manager_record['manager_id']) )}}" class="btn btn-success">Active</a>
               @else
               <a href="{{url('employee/other-party-activation/'.Hashids::encode($main_other_party_register_users['main_user_id']).'/'.Hashids::encode($manager_record['manager_id']) )}}" class="btn btn-danger">In Active</a>
               @endif -->
