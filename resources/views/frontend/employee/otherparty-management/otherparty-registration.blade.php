		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					@endif
					<form action="{{url('employee/store-other-party')}}" class="-bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
						<div class="modal-body">
                            ...
                            <div class="form-group" align="center">
								<a href="{{url('emplloyee/manage-other-parties')}}" class="btn btn-info">
									Go back
								</a>
