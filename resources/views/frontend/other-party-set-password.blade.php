...
<div class="login-form">
  ...
  <div class="row">
   ...
   @endif 
   <form action="{{url('other-party-set-password')}}" class="bootstrap-modal-form" method="post">
        {{ csrf_field() }}
    ...
    <input type='hidden' name='other_party_id' value="{{$other_party_id}}" class="form-control"/>
