         ...
         <div class="container">
          <div class="row">
           <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-6  col-sm-offset-6">
            ...
            <form class="bootstrap-modal-form" action="{{url('manager-registration')}}" method="post" files='true'>
            {{ csrf_field() }}
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <select id="purpose" name="business_category_type" class="form-control">
                  ...
                  <option style="color:brown;font-size:17px;" readonly>{{$business_categorie->category_name}}</option>
                  @foreach($business_categorie->professions as $profession)
                  <option value="{{$profession->business_profession_type}}">{{$profession->business_profession_type}}</option>
                  @endforeach
                  @endforeach
