 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      ...
      <form method="post" action="{{url('manager/trash')}}">
        {{ csrf_field() }}
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
             ...
             <div class="col-md-2">
               <a href="{{url('manager/mail-box')}}" class="btn {{ Request::is('manager/mail-box/*')? 'btn-primary' : 'btn-warning'}}"><span class="fa fa-envelope"></span> All</a>
             </div>
             <div class="col-md-2">
              <a href="{{url('manager/mail-box/ad')}}" class="btn {{ Request::is('manager/mail-box/ad')? 'btn-warning' : 'btn-primary'}} btn-block margin-bottom"><span class="fa fa-envelope"></span> Admin</a>
              </div>
              <div class="col-md-2">
              <a href="{{url('manager/mail-box/em')}}" class="btn {{ Request::is('manager/mail-box/em')? 'btn-warning' : 'btn-primary'}} btn-block margin-bottom"><span class="fa fa-envelope"></span> Employees</a>
              </div> 
              <div class="col-md-2">
              <a href="{{url('manager/mail-box/cl')}}" class="btn {{ Request::is('manager/mail-box/cl')? 'btn-warning' : 'btn-primary'}} btn-block margin-bottom"><span class="fa fa-envelope"></span> Clients</a>
              </div>
              <div class="col-md-2">
               <a href="{{url('manager/mail-box/ot')}}" class="btn {{ Request::is('manager/mail-box/ot')? 'btn-warning' : 'btn-primary'}} btn-block margin-bottom"><span class="fa fa-envelope"></span> Other Party</a>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="{{$inbox_message->master_table_email_id}}">
                    ...
                    <td>
                    <a href="{{url('manager/important',$inbox_message->master_table_email_id)}}"><i style="color:#999" class="fa fa-star @if($inbox_message->user_id != "") text-yellow @endif"></i></a></td>

                    <td class="mailbox-name"><a href="{{url('manager/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'.Hashids::encode(1) )}}" title="Subject">{{$inbox_message->subject}}</a></td>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="{{$inbox_message->master_table_email_id}}">
                    ...
                    <td>
                     <a href="{{url('manager/important',$inbox_message->master_table_email_id)}}"><i style="color:#999" class="fa fa-star @if($inbox_message->email_table_id != "") text-yellow @endif"></i></a></td>
                    </td>
                    <td class="mailbox-name"><a href="{{url('manager/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'. Hashids::encode(2) )}}" title="Subject">{{$inbox_message->subject}}</a></td>
