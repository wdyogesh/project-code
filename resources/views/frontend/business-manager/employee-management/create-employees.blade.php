		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					@endif
					<form action="{{url('manager/store-employee')}}" class="bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control" name="role_name">
											...
											<option value="{{$business_managers_employee_role->id}}">{{$business_managers_employee_role->employee_role_name}}</option>
											@endforeach
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Employee Name" name="employee_name" value="{{old('employee_name')}}" maxlength="25">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Surname" name="surname" value="{{old('surname')}}" maxlength="20">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Employee Email" name="employee_email" value="{{old('employee_email')}}" maxlength="30">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Pin Code" name="pincode" value="{{old('pincode')}}" maxlength="6">
