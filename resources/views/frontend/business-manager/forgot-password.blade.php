...
<title>Intell-Comm-Manager Forgot Password</title>
...
<div class="login-form">
  ...
  <div class="row">
   @if (Session::has('message'))
    ...
    @endif
    @if (Session::has('fail'))
    <div  align="center" id="successMessage" class="alert alert-danger" style="color:red">{{ Session::get('fail') }}
    </div>
    @endif
     @if ($errors->any())
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <form  action="{{url('manager/forgot-password')}}" class="bootstrap-modal-form" method="post">
      {{ csrf_field() }}
    ...
    <div class="learn_more_btn">
      ...
      <div class="learn_more_btn">
      <a href="{{url('manager-login')}}" style="color:#8a6d3b">Do you want to go login?</a>
    </div><br>
    <div class="learn_more_btn">
      <a href="{{url('manager-login')}}"> <a href="#" style="color:#3c763d">If you don't remember the e-mail address, contact us at intell@gmail.com</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div class="learn_more_btn">
      <!-- <a href="{{url('manager-registration')}}">Do you want to register?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="{{url('manager/forgot-password')}}">Forgotten account?</a> -->
    </div>
   </div>
    </form>
    </div>
