		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="{{url('manager/create-notes-category')}}" class="btn btn-info pull-right">
					 Add
				 </a>
				...
				<table id="example1" class="table table-bordered table-striped">
					...
					@if(isset($all_records))
						...
						<tr>
							...
							@endif
							<td>
							@if($category['role_name'] == "Staff")
							--
							@else
							 <a href="{{url('manager/edit-notes-category/'.Hashids::encode($category['category_id']))}}" class="btn btn-info" title="Edit">
...
<script>
	var url = "{{url('manager/delete-notes-category')}}";
