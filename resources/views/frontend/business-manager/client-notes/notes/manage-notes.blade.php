		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a href="{{url('manager/create-client-notes')}}" class="btn btn-info pull-right">
					 Create
				 </a>
					...
					@if(isset($all_client_notes))
						...
						<tr>
                           ...
                           @endif
							...
							@endif
							<td>
							 <a href="{{url('manager/note-details/'.Hashids::encode($notes['notes_id']))}}" class="btn btn-warning btn-detail open_modal" title="Details">
								<span class="glyphicon glyphicon-folder-open"></span>
							 </a>
							 @if($notes['role_name'] == 'Staff' || $notes['role_name'] == 'Clients')
							 @else
							 <a href="{{url('manager/edit-notes/'.Hashids::encode($notes['notes_id']))}}" class="btn btn-info" title="Edit">
...
<script>
	var url = "{{url('manager/delete-notes')}}";
