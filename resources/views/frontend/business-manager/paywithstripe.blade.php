        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{{url('manager/addmoney/stripe')}}" >
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="text" class="form-control" name="amount" value="$ {{$package_plan_access['price']}}" autofocus readonly>
