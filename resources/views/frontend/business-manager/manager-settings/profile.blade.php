            ...
            <div class="box-body box-profile">
             ...
             @endif 
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Business Name</b> <a class="pull-right">{{$user_profile['businessdetails']['businesss_name']}}</a>
                </li>
                <li class="list-group-item">
                  <b>Business Type</b> <a class="pull-right">{{$user_profile['businessdetails']['business_type']}}</a>
                </li>
              </ul>

              <a href="{{url('manager/edit-profile/'.Hashids::encode($user_profile['id']))}}" class="btn btn-primary btn-block"><b>Edit</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
