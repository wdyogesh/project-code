...
<body>
  ...
  <div class="registration_section main">
   ...
   @endif 
    <form  action="{{url('manager-login')}}" class="bootstrap-modal-form" method="post">
      {{ csrf_field() }}
    ...
    @if(isset($user_email))
      <input type="text" class="form-control" id="email" name="email"  value="{{$user_email['email']}}" placeholder="Email" readonly>
    @else
    ...
    <div class="learn_more_btn">
     <!--  <a href="{{url('manager-registration')}}">Do you want to register?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
      <a href="{{url('manager/regitered-security-questions-choosing/'.$kay_user_send_login_forgot)}}">Forgotten account?</a>
    </div>
   </div>
    </form>
      </div>
