  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-xs-8" style="float: right;">
            ...
            <div class="col-xs-1">
                <a href="{{url('manager/appointments/'.Hashids::encode(1))}}" class="btn {{ Request::is('manager/appointments') || Request::is('manager/appointments/'.Hashids::encode(1))? 'btn-warning' : 'btn-info'}}">
              1 Day
               </a>
            </div>
            <div class="col-xs-1">
              <a href="{{url('manager/appointments/'.Hashids::encode(3))}}" class="btn {{Request::is('manager/appointments/'.Hashids::encode(3))? 'btn-warning' : 'btn-info'}}">
                  3 Days
              </a>
            </div>

            <div class="col-xs-1">
               <a href="{{url('manager/appointments/'.Hashids::encode(6))}}" class="btn {{Request::is('manager/appointments/'.Hashids::encode(6))? 'btn-warning' : 'btn-info'}}">
                  6 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="{{url('manager/appointments/'.Hashids::encode(7))}}" class="btn {{Request::is('manager/appointments/'.Hashids::encode(7))? 'btn-warning' : 'btn-info'}}">
                  7 Days
              </a>
            </div>
            <div class="col-xs-1">
               <a href="{{url('manager/appointments/'.Hashids::encode(5))}}" class="btn {{Request::is('manager/appointments/'.Hashids::encode(5))? 'btn-warning' : 'btn-info'}}">
                  Work Week
              </a>
            </div>
      </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" style="">
          <div>    <!-- //start form -->
            <form action="{{url('manager/store-appointment')}}" class="bootstrap-modal-form form-horizontal" method="post">
             {{ csrf_field() }}
          ...
          <input type="hidden" id="business_start_time" name="business_start_time" value="{{$business_start_time}}">
          <input type="hidden" id="business_end_time" name="business_end_time" value="{{$business_end_time}}">
    ...
    <div id="record-edit" style="display: none">  
      ...
      <div class="modal-body">
        <div id="view-show" class="box-body">
          <form action="{{url('manager/update-appointment')}}" class="bootstrap-modal-form form-horizontal" method="post">
            {{ csrf_field() }}
...
<script>
  var deleteurl = "{{url('manager/delete-appointment')}}";
  var editurl = "{{url('manager/edit-client-appointment')}}";
  var access_client_hash_id = "{{url('manager/client-id')}}";
  var redirect_url= "{{url('manager/client-details')}}";
  var appointment_page_url= "{{url('manager/appointments')}}";
  var arrived_url= "{{url('manager/client-arrived-check')}}";
  var dna_url= "{{url('manager/client-dna-check')}}";
  var in_process_url= "{{url('manager/client-in-process-check')}}";
  var seen_url= "{{url('manager/client-seen-check')}}";
