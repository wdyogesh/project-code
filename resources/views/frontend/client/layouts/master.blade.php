...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		@include('frontend.client.layouts.header')
		<!-- Left side column. contains the logo and sidebar -->
		@include('frontend.client.layouts.sidebar')
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			         ...
			         <form action="{{url('client/edit-profile-picture')}}" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
			         {{ csrf_field() }}
