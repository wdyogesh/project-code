...
@section('content')
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="{{url('client/add-group')}}" class="btn btn-info pull-right">
           Add Group
      </a>
    </section>
        ...
        @if(isset($mail_group))
          @foreach($mail_group as $group)
            ...
            <tr>
              ...
              @if($group['mail_group_common_user_id'] == Auth::user()->id)
              <td>
               <a href="{{url('client/edit-group/'.Hashids::encode($group['group_user_id']))}}" class="btn btn-info" title="Edit">
...
<script>
var url = "{{url('client/delete-group')}}";
