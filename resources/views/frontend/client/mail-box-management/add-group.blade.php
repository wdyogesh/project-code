...
@section('content')
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="{{url('client/mail-box')}}" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
        ...
        <div class="col-md-9">
		  ...
		  @endif   
            <!-- /.box-header -->
         <form action="{{url('client/add-group')}}" class="-bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Email" name="email" value="{{old('email')}}">
                   ...
                   <div class="col-sm-3">
                    ...
                    <!-- <span class="text-danger">{{ $errors->first('email') }}</span> -->
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control" id="employee" name="employee[]"  multiple="multiple">
				                             ...
				                             <option value="{{$employee->id}}">{{$employee->email}}[{{$employee->name}} {{$employee->surname}}]</option>
				                             @endforeach
                                        </select>
                            ...
                            <div class="form-group" align="center">
							    <a href="{{url('client/manage-group')}}" class="btn btn-info">Group Back</a>
