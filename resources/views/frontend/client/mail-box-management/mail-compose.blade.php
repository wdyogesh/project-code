          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{url('client/compose-message/ot')}}" class="btn {{ Request::is('client/compose-message/ot')? 'btn-warning' : 'btn-default'}}"><span class="fa fa-envelope"></span> Other Party</a>
               ...
               <div class="col-md-2">
                <a href="{{url('client/compose-message')}}" class="btn btn-default btn-sm" title="Refresh"><i class="fa fa-refresh"></i></a>
              </div>
            </div>
            <!-- /.box-header -->
          <form action="{{url('client/send-mail')}}" class="-bootstrap-modal-form" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
