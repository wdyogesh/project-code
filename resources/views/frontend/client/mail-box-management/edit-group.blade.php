    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
		  ...
		  @endif   
            <!-- /.box-header -->
         <form action="{{url('client/edit-group')}}" class="-bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
							...
							<div class="box-body">
                              <div class="form-group" style="font-size: 18px;margin-left:140px; ">
								...
								<div class="form-group">                  
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="inputEmail3" placeholder="Enter Grouop Email" name="email" value="{{$record['email']}}">
