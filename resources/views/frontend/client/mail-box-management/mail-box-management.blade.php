 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper manager-content-wrapper">
    ...
    <section class="content">
      ...
      <form method="post" action="{{url('client/trash')}}">
        {{ csrf_field() }}
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="{{$inbox_message->master_table_email_id}}">
                    ...
                    <td>
                    <a href="{{url('client/important',$inbox_message->master_table_email_id)}}"><i style="color:#999" class="fa fa-star @if($inbox_message->user_id != "") text-yellow @endif"></i></a></td>

                    <td class="mailbox-name"><a href="{{url('client/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'.Hashids::encode(1) )}}" title="Subject">{{$inbox_message->subject}}</a></td>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="{{$inbox_message->master_table_email_id}}">
                    ...
                    <td>
                     <a href="{{url('client/important',$inbox_message->master_table_email_id)}}"><i style="color:#999" class="fa fa-star @if($inbox_message->email_table_id != "") text-yellow @endif"></i></a></td>
                    </td>
                    <td class="mailbox-name"><a href="{{url('client/read-message-details/'.Hashids::encode($inbox_message->master_table_email_id).'/'. Hashids::encode(2) )}}" title="Subject">{{$inbox_message->subject}}</a></td>
