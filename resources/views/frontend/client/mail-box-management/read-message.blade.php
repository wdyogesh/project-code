          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                 <form @if($dummy_page_wise_numbers == 5) action="{{url('client/detail-message-perminant-delete')}}" @else action="{{url('client/detail-message-trash')}}"@endif method="post">
                  {{ csrf_field() }}
                  ...
                  <!--  <a href="{{url('client/employee-reply-message/'.Hashids::encode($message_record_detail['id']).'/'. Hashids::encode($dummy_page_wise_numbers) )}}" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Reply"><i class="fa fa-reply"></i></a> -->
