...
<div class="login-form">
  ...
  <div class="row">
   ...
   @endif 
    <form class="-bootstrap-modal-form" action="{{url('other-party-set-security-question')}}" method="post" files='true'>
{{ csrf_field() }}
    ...
    <div class="form-group" style='display:none;' id='security_question_answer'>
     ...
     <input type='hidden' name='other_party_id' value="{{$other_party_user_id}}" class="form-control"/>
