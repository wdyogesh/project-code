...
<head>
  ...
  <title>Intell-Comm Other Party Remember Security Question</title>
...
<body>
  ...
  <div class="registration_section main">
   <div class="container">
    ...
    <form class="bootstrap-modal-form" action="{{url('other-party/check-security-question-answer')}}" method="post" files='true'>
    {{ csrf_field() }}
