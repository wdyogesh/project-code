...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		@include('frontend.other-party.layouts.header')
		<!-- Left side column. contains the logo and sidebar -->
		@include('frontend.other-party.layouts.sidebar')
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			         ...
			         <form action="{{url('other-party/edit-profile-picture')}}" method="post" class="bootstrap-modal-form form-horizontal" enctype="multipart/form-data">
			         {{ csrf_field() }}
		...
		<!-- /.content-wrapper -->
		@include('frontend.other-party.layouts.footer')
