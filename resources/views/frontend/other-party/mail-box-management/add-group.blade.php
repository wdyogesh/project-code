    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-9">
		  ...
		  @endif   
            <!-- /.box-header -->
         <form action="{{url('other-party/add-group')}}" class="-bootstrap-modal-form form-horizontal" method="post">
						{{ csrf_field() }}
                   ...
                   <div class="col-sm-3">
                    ...
                    <!-- <span class="text-danger">{{ $errors->first('email') }}</span> -->
                            ...
                            <div class="form-group" align="center">
							    <a href="{{url('other-party/manage-group')}}" class="btn btn-info">Group Back</a>
