          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                 <form @if($dummy_page_wise_numbers == 5) action="{{url('other-party/detail-message-perminant-delete')}}" @else action="{{url('other-party/detail-message-trash')}}"@endif method="post">
                  {{ csrf_field() }}
