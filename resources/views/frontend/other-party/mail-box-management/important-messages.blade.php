                ...
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="{{$important_message->email_table_id}}">
                    ...
                    <td>
                     <a href="{{url('other-party/important',$important_message->master_table_email_id)}}"><i style="color:#999" class="fa fa-star @if($important_message->email_table_id != "") text-yellow @endif"></i></a>
                    </td>
                    <td class="mailbox-name"><a href="{{url('other-party/read-message-details/'.Hashids::encode($important_message->master_table_email_id).'/'. Hashids::encode(6) )}}" title="Subject">{{$important_message->subject}}</a></td>
