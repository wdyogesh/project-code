      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            @endif
            <form action="{{url('other-party/edit-profile')}}" class="-bootstrap-modal-form form-horizontal" method="post">
               {{ csrf_field() }}
              ...
              <div class="modal-footer">
                <a href="{{url('other-party/profile')}}" class="btn btn-info pull-left">
               Go back
              </a>
