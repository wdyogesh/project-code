...
<head>
  ...
  <title>Intell-Comm Other Party Forgot Password</title>
...
<body>
  ...
  <div class="registration_section main">
   <div class="container">
    ...
    <form  action="{{url('other-party/forgot-password')}}" class="bootstrap-modal-form" method="post">
      {{ csrf_field() }}
    ...
    <div class="learn_more_btn">
      ...
      <div class="learn_more_btn">
      <a href="{{url('other-party-login')}}" style="color:#8a6d3b">Do you want to go login?</a>
    </div><br>
   <!--  <div class="learn_more_btn">
